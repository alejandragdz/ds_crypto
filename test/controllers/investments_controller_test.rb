...
class InvestmentsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create investment" do
    assert_difference("Investment.count") do
      post investments_url, params: { investment: { balance_init: @investment.balance_init, coin: @investment.coin, interest: @investment.interest } }
    end
  ...
  test "should update investment" do
    patch investment_url(@investment), params: { investment: { balance_init: @investment.balance_init, coin: @investment.coin, interest: @investment.interest } }
